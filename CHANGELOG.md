...
- Phase 12 implementation checked into `main` with passing GitHub CI: schema-versioned analysis plans and
  ...
  package-version change was made. A release remains a separate owner decision.
